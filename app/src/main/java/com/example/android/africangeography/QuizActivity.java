...
public class QuizActivity extends AppCompatActivity {
    ...
    public int calculatePercentage() {
        ...
        if (question1.getCheckedRadioButtonId() == R.id.answer1_2_correct) {
            percentageScore += 20;
        }
        ...
        if (answerForQuestionFour.equals("Nigeria")) {
            percentageScore += 20;
        }

        //Radio Group for Question 5
        RadioGroup question5 = findViewById(R.id.radio_group_5);
        if (question5.getCheckedRadioButtonId() == R.id.answer5_2_correct) {
            percentageScore += 20;
        }
    ...
    public void submit(View view) {
        ...
        //Inputs the Phrase "Answer: Nigeria" into the variable correctNameOfCountry for question 4
        String correctNameOfCountry = "Answer: Nigeria";
        ...
        // This helps indicates the correct answers by changing their color to blue
        TextView TxtColorChange1 = findViewById(R.id.answer1_2_correct);
        ...
        TextView TxtColorChange5 = findViewById(R.id.answer5_2_correct);
        TxtColorChange1.setTextColor(Color.BLUE);
        TxtColorChange2a.setTextColor(Color.BLUE);
        TxtColorChange2b.setTextColor(Color.BLUE);
        TxtColorChange3.setTextColor(Color.BLUE);
        TxtColorChange5.setTextColor(Color.BLUE);
        ...
        //Shows the value of name and displays message to the user indicating the right answers are now coloured blue
        displayMessage("Hello " + valueOfName + ". Check for the correct answers, they are now coloured blue");

        //Calls the displayNigeria method to display the Correct answer for Question 4
        //If the correct answer "Nigeria" is typed by the user, it displays the text "You are right!"
        // else it displays the value of correctNameOfCountry which is "Answer: Nigeria"
        EditText answerQuestionFour = findViewById(R.id.answer4);
        String answerOfQuestionFour = answerQuestionFour.getText().toString();
        if (answerOfQuestionFour.equals("Nigeria")) {
            displayNigeria("You were correct!");
        } else {
            displayNigeria(correctNameOfCountry);
        }
     ...
     */
    private void displayNigeria(String countryName) {
        TextView displayNigeria = findViewById(R.id.display_nigeria);
        displayNigeria.setText(countryName);
    }
